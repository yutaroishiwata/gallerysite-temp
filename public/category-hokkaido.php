...
<div id="content">
	<article id="main_content">
                ...
                <section id="select_shop_area" class="clearfix sp_wrap_neg">
                       ...
                       <ul id="pref_tabMenu">
                           <div><li>HOKKAIDO<svg class="arrow_down"><use xlink:href="#arrow_down"></use></svg></li></div><!--北海道-->
                       </ul>
                       
                       <div id="pref_tabBoxes">
                            <div>
                            <li><a href="<?php echo get_category_link('26'); ?>" title="北海道">全エリア</a></li>
                            <?php  wp_list_categories('child_of=26&show_count=1&hide_empty=0&title_li=&orderby=count&order=DESC'); ?>
                            </div>
                        </div>
